...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN] = LAYOUT_wkl_ISO(
    ...
    KC_BSPC, ______,  KC_UP,   ______,   KC_END, ______, ______, ______, ______, ______, ______, ______, ______,                  ______,  \
    ...
    ______,       ______,                                    OSM(MOD_LGUI),                                ______,          ______, ______, ______ \
  ),
