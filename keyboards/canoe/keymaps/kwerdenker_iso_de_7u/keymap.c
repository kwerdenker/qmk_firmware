/*
Copyright 2019 Sebastian Spindler <thinkkwer@gmail.com>
...
#define SPECIAL LT(_F1, DE_CIRC)    //capslock layer switch + stargate key on tap
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MA] = LAYOUT_iso(
    ...
    SPECIAL,  KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,   KC_L,KC_SCLN,KC_QUOT,KC_NUHS, KC_ENT, KC_PGDN,  \
    KC_LSFT,  KC_NUBS,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,KC_COMM, KC_DOT,KC_SLSH,KC_RSFT,  KC_UP, KC_PSCR,  \
    KC_LCTRL,KC_LGUI,KC_LALT,               KC_SPC,                        _______, KC_RALT,KC_LEFT,KC_DOWN, KC_RGHT),
  ...
  [_F1] = LAYOUT_iso(
    ...
    _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,RGB_MOD,RGB_RMOD,RGB_M_P,RGB_TOG,RGB_VAD, \
