...
void matrix_init(void)
{
    ...
    tinycmd_config(17, 260, true);
    _delay_ms(10);
    tinycmd_rgb_effect_speed(100, true);
    _delay_ms(10);
  ...
  tinycmd_rgb_set_preset(5, (rgb_effect_param_type *)&rgb_effect_param[5], true);
  tinycmd_rgb_set_effect(5, true);
  _delay_ms(10);
